 ...
 *       Define static inline functions code, so #include header suffices for
 *use. This may use up lots of memory.
 *
 *   CONVENTIONS:
 *
...
RMAPI Matrix MatrixPerspective(double fovy, double aspect, double near,
                               double far) {
  Matrix result = {0};
